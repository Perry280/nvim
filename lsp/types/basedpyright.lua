...
---@class settings.basedpyright.Basedpyright.Analysis.DiagnosticSeverityOverrides
...
---@class settings.basedpyright.Basedpyright.Analysis.InlayHints
...
---@class settings.basedpyright.Basedpyright.Analysis
...
---Allows a user to override the severity levels for individual diagnostics. Use the rule name as a key and one of "error", "warning", "information", "none", `true` (alias for "error") or `false` (alias for "none") as value. The default value shown for each diagnostic is the default when "basedpyright.analysis.typeCheckingMode" is set to "standard". See [here](https://docs.basedpyright.com/latest/configuration/config-files/#diagnostic-settings-defaults) for defaults for each type checking mode ("off", "basic", "standard", "strict", and "all").
---@field diagnosticSeverityOverrides? settings.basedpyright.Basedpyright.Analysis.DiagnosticSeverityOverrides
...
---@field inlayHints? settings.basedpyright.Basedpyright.Analysis.InlayHints
...
---@class settings.basedpyright.Basedpyright
---@field analysis? settings.basedpyright.Basedpyright.Analysis
...
---@class settings.basedpyright.Python
...
---@class settings.basedpyright
---@field basedpyright? settings.basedpyright.Basedpyright
---@field python? settings.basedpyright.Python
